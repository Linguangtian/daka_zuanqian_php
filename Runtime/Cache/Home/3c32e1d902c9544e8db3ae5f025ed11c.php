...
<body style="background: #20255c;overflow-y: hidden;">
<!-- 头部部分 开始 -->
<header class="top_header">
    <div class="left"><a href="javascript:" data-url="<?php echo U('Task/index');?>" class="return go-back" ></a></div>
    <div class="title">邀请</div>
    <div class="right">
        <a href="<?php echo U('Page/show', ['id' => 4]);?>">邀请规则</a>
    </div>
</header>
