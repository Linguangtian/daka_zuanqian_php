...
<div class="login">
    ...
    <div class="login-form">
        <form class="submit-ajax" action="<?php echo U('reg');?>">
            ...
            <!-- // TODO 修改注册  --><!--//TODO 20191027-->
            <div class="reg_email" style="display:<?php echo C('EMAIL_STATUS') ?'':'none' ;?>">
            ...
            <div class="reg_phone" style="display:<?php echo C('EMAIL_STATUS') ?'none':'block' ;?>">
                <div class="login-inp" style="background: #f4f4f4;border: none;">
                    <label style="color: #999;">注册账号</label>
