...
<!--	<div class="found-home">
		<ul>
			<li>
				...
				<p>普通用户</p>
				<a href="<?php echo U('Index/serach',array('level'=>0));?>">GO <i></i></a>
			</li>

			<li>
				<img src="/tpl/Public/images/2db7bc1361e32522118937b4658c3173_Eww0gADgi0AAAAASUVORK5CYII=.png"/>
				<p>高级会员</p>
				<a href="<?php echo U('Index/serach',array('level'=>1));?>">GO <i></i></a>
			</li>

			<li>
				<img src="/tpl/Public/images/lu.png"/>
				<p>尊享会员</p>
				<a href="<?php echo U('Index/serach',array('level'=>2));?>">GO <i></i></a>
			</li>
			<li>
