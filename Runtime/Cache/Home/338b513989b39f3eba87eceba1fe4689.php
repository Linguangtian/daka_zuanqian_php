<?php if (!defined('THINK_PATH')) exit(); $title = "提交任务";?>
<!DOCTYPE html>
...
<div class="body_main mt tline">
    <div class="task_box">
        <div class="submission_task_form">
            <form class="submit-ajax" method="post" id="from1" action="<?php echo U('submission_task_do');?>">
                ...
                <div class="item">
                    ...
                    <div class="auto_upload add_upload" style="width: 292px; height: 180px; margin: 0 auto">
                        <div id="upload-5dd0bc83eb3d68066920" class="xb-uploader">
    <div class="queueList">
    ...
    <div class="statusBar" style="display:none;">
        ...
        <div class="btns">
            <div class="webuploader-container filePicker2">
                ...
                <div style="position: absolute; top: 0px; left: 0px; width: 1px; height: 1px; overflow: hidden;" id="rt_rt_upload-5dd0bc83eb3d68066920">
                </div>
            </div>
...
jQuery(function() {
    var $ = jQuery,    // just in case. Make sure it's not an other libaray.
        ...
        $wrap = $("#upload-5dd0bc83eb3d68066920"),
        ...
        // 缩略图大小
        thumbnailWidth = 292 * ratio,
        thumbnailHeight = 179 * ratio,
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-5dd0bc83eb3d68066920 .filePicker",
            label: '',
            multiple : true
        },
        dnd: "#upload-5dd0bc83eb3d68066920 .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
        ...
        chunked: true,
        server: "/index.php/Home/Index/ajax_upload.html",
        fileNumLimit: 1,
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-5dd0bc83eb3d68066920 .filePicker2",
       label: '继续添加'
    });
    ...
    function addFile( file ) {
        var $li = $( '<li id="' + file.id + '">' +
                ...
                '<input class="bjy-filename" type="hidden" name="file">'+
                '</li>' ),
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-5dd0bc83eb3d68066920 .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-5dd0bc83eb3d68066920 .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-5dd0bc83eb3d68066920 .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
    ...
    updateTotalProgress();
                ...
                <div>
                    <button type="submit" class="bala-btn" style="margin-top: 20px;margin-bottom: 20px;width: 260px;">提交任务</button>
                </div>
            </form>
            <div class="tip">
            </div>
