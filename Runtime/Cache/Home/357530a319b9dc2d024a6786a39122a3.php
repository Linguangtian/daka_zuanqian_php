...
<style>
    ...
    .show_lllqqqe{
        height:auto;}
    .show_dypl{
        padding:0;margin-top:0;font-size: 13px;height: auto;line-height: normal;width:81%
    }
    .show_tips span{
        width:31%;
        display: inline-block;font-size: 11px;
        color: #a7a4a4;text-align: left;
    }
    .show_index_sss p{
        line-height:normal;
        height:auto;
    ...
    .show_sssss img{
        width: 15px;
        height: 15px;;;}
    .show_sssss{font-size: 12px;height: 2rem;margin-top:-10px;width:31%;
        line-height: 2.2rem;}

    .show_zpllj{height: 2.5rem;line-height: 2.5rem;}
    ...
    .show_srwssss{margin-bottom:45px;}
 ...
 <div class="show_index_top">
    ...
    <!--提醒-->
 	<p class="shop_index_ts" style="text-decoration:none;text-align: left;height:2.0rem;line-height: 2.0rem;">
        ...
        <span style="color: #39c773;font-size: 10px;font-weight: initial">赏金已托管,赚钱有保障!</span>
    </p>
 	...
 	<div class="show_index_f" style="padding: 10px 0;height: auto;">
 		...
 		<p class="show_wqq show_dypl" style="width: 10%;padding-right: 3%">+<?php echo (floatval($show["price"])); ?>元</p>
    ...
    <div class="show_index_sss" style="height: 60px;line-height:60px;border-bottom: 1px solid #ccc;">
        ...
        <span style="display: inline-block;color: #39c773;font-size: 15px;margin-top: -20px;font-weight: initial"><?php echo ($show["username"]); ?></span>
 	...
 	<div class="show_renws" style="height: auto;">
        ...
        <div style="clear: both;padding-top:5px"></div>
 		...
 		<div class="copy_btn">
          <div class="t3" style="display:n;color:#fff;height: 20px;background: ;overflow: hidden;"><?php echo ($show["taskuser"]); ?><input id="foo" type="text" value="<?php echo ($show["taskuser"]); ?>" style="height: 1px;width: 1px;position: absolute;top: 0;left: 0;"></div>
 		<p class="show_zpllj" style="overflow: hidden;" id="text"><?php echo ($show["taskuser"]); ?> <input id="foo" type="text" value="<?php echo ($show["taskuser"]); ?>" style="height: 1px;width: 1px;position: absolute;top: 0;left: 0;"></div> </p>
      <button type="button" class="show_djfzz copy" data-clipboard-action="copy" data-clipboard-target="#foo" style="background:#fff;width:30%">点击复制</button>
    ...
    <p style="width: 100%;height: 10px;background: #ededed;margin-top: 10px;"></p>
 	<?php if($btn_status == 1): ?><a href="#" class="show_lllqqqe">
            <button type="button" class="bala-btn get_task" style="width:100%;margin:0;background:linear-gradient(90deg,#9672f7,#7045f2) ;border: none;"><?php echo ($status_text); ?></button>
        </a>
    <?php else: ?>
        <a href="<?php echo ($redirect_url); ?>" class="show_lllqqqe">
            <button type="button" class="bala-btn" style="width:100%;;background: #fff;background: linear-gradient(90deg,#9672f7,#7045f2);border: none;"><?php echo ($status_text); ?></button>
        </a><?php endif; ?>
