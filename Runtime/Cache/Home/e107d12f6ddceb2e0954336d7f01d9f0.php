	...
	<div class="user_index_top" style="clear: both;">
		<div class="user_index_top_t">
			...
			<a href="<?php echo U('Member/info');?>">
				<img id="set" src="/tpl/Public/images/set.png" alt="" width="40" style="">
			</a>
		</div>

		<div class="usermes wrap-flex-row">
			<div class="mesBox">
				<div class="text"><?php echo (floatval($total_price["all"])); ?></div>
				<div class="num">累计收益</div>
			</div>
			<span class="u-data-g">|</span>
			<div class="mesBox">
				<div class="text"><?php echo ($data["price"]); ?></div>
