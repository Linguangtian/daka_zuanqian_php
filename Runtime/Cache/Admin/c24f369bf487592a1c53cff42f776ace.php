...
<head>
    ...
    <style type="text/css">
        ...
        .layui-layer-setmybg .layui-layer-title{background: #ff5196}
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <div class="sidebar-collapse" data-version="<?php echo ($has_version); ?>" id="sidebar-collapse">
        ...
        <div class="main-content">
            ...
            <!--检查更新 只是为了方便后期跟新升级,请勿删除-->
            <div class="footer">
                <a href="">© <?php echo sp_cfg('website');?></a>
                <span>　　　版本号</span>
                v <?php echo C('VERSION');?> <a onclick="updateV()" href="javascript:void(0)"> 检查更新</a>
            </div>
        </div><!-- /.main-content -->
...
$(function(){
    ...
    $('.page-content,.main-content').height($(window).height()-70);
    $('.page-content').css('padding-bottom',70);

    // 左侧菜单自动适应高度
    $('#sidebar .nav-list').height($(window).height());

    if ( $('#sidebar-collapse').data('version') ){
...
function ClearCache() {
    ...
    layer.confirm('确认清理缓存？', {
        ...
        window.location.href = "<?php echo U('Index/clear');?>";
