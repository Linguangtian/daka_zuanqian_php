...
<ul id="myTab" class="nav nav-tabs">
   <li class="active">
         <a href="<?php echo U('index', $get);?>">系统消息列表</a>
   </li>
   <li>
        <a href="<?php echo U('add');?>">添加系统消息</a>
    </li>
</ul>
<table class="table table-striped table-bordered table-hover table-condensed">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
            ...
            <td>
                <?php if($vo['role_type'] == 0): ?>全部<?php endif; ?>
                <?php if($vo['role_type'] == 1): ?>普通会员<?php endif; ?>
                <?php if($vo['role_type'] == 2): ?>信贷员<?php endif; ?>
            </td>
