...
console.log("%c 云速众客 %c Copyright \xa9 %s https://zk.mfapi.cn",'font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;font-size:64px;color:#00bbee;-webkit-text-fill-color:#00bbee;-webkit-text-stroke: 1px #00bbee;',"font-size:12px;color:#999999;",(new Date).getFullYear());
console.log("%c "+'承接软件开发 系统定制 源码搭建 二次开发 QQ:1044766678！^_^',"color:#333;font-size:16px;");
console.log("\n "+'云速众客，任务悬赏平台。 https://zk.mfapi.cn');
...
function flashupload(uploadid, name, inputid, funcName, path, thumb_width, thumb_height, authkey) {
    ...
    art.dialog.open('/index.php/Admin/Public/swfupload2/' + param, {
        title: name,
        id: uploadid,
        width: '650px',
        height: '320px',
